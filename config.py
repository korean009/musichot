...
API_ID = int(getenv("API_ID", 27838385))
...
YT_API_KEY = getenv("YT_API_KEY", 'xbit_V8kZ9DMNn4iPVWNIATvpbcr-RMDTSC1E') ## Your API key like: xbit_10000000xx0233 Get from  https://t.me/tgmusic_apibot
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/globalchatverse")
SUPPORT_OWNER = getenv("SUPPORT_OWNEE", "http://t.me/smxcii")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/e9c12l.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/j8s4ol.jpg"
)
